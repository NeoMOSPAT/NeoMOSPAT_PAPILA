...
sys.path.append("/home/m/m301017/Codes-PAPILA/NeoMOSPAT/SIMULDIR")
...
## Freq for models and obs
c_TimeMeanRes = ["H"]
c_Start_Date = ['01-01-2015', '07-07-2015']
c_Last_Date = ['20-01-2015', '13-07-2015']
## Images to save path to
c_FigureDir = '../Images_NeoMOSPAT/PAPILA/'
...
################################################################
###############        Models     SET-UP        ################
c_ModelDir = "/home/m/m301017/PAPILA/modelling_regridded/MOSPAT_input/"
c_ModelNames = ["CAMS-IFS-ECMWF2", "Chimere", "WRF-MPI", "WRFChem-USP-new"]
c_ModelAlias = ["CAMS2","Chimere", "MPI", "USP"]
b_TS_hl1stmodel=False
c_RunName="Prueba_CAMS"


c_ObsNetwork = ["PAPILA-Obs"]
dir_geojson="/home/m/m301017/Codes-PAPILA/NeoMOSPAT/SIMULDIR/geojson"
c_RegionMask=[dir_geojson+"/Bogota.geojson", dir_geojson+"/Valparaiso.geojson",dir_geojson+"/Concepcion.geojson", dir_geojson+"/Quito_new.geojson"]
c_RegionMaskAlias=["BogotaOriginal", "Valparaiso", "Concepcion", "Quito_new"]

b_TS_plotfilters=True
b_TS_plotstations = True
###### Model Filters.
## Specifies which filters are turned on for models
i_ModelFilters = 1
